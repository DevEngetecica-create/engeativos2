        ...
        <div class="card-body p-5">
            ...
            <div class="row">
                <div class="col-sm-12 col-xl-6">
                    <form action="{{ route('estoque.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                         ...
                         <div class="form-group mb-3">
                            ...
                            <select class="form-select select2" id="id_obra" name="id_obra">
                                ...
                                @foreach ($obras as $obra)
                                     <option value="{{ $obra->id }}" {{ $product->id_obra == $obra->id ? 'selected' : '' }}>
                 ...
                 <div class="col-sm-12 col-xl-6">
                    ...
                    @if($product->image)
                        <img id="preview" src="{{ asset("build/assets/images/product/{$product->id}/" . $product->image) }}" class="border mt-2" width="500">
                    @endif
