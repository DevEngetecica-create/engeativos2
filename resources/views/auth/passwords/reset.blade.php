                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="useremail" name="email" placeholder="Insira email cadastrado no sistema" value="{{ $email ?? old('email') }}" id="email">
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            <label for="userpassword">Confirmar a Senha</label>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Lembrou da senha... <a href="auth-signin-basic"
                                class="fw-semibold text-primary text-decoration-underline"> Click aqui!!! </a>
                            </p>
                        </div>
