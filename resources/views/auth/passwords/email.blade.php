            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card my-4 ">
                        ...
                        <div class="card-body p-5 pb-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">Recuperar a senha?</h5>
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="useremail" name="email" placeholder="Insira email cadastrado no sistema" value="{{ old('email') }}" id="email">
                                        @error('email')
                    ...
                    <div class="mt-5 text-center">
                        <p class="mb-0">Lembrou da senha? <a href="{{ route('login') }}" class="fw-semibold text-primary text-decoration-underline"> Clique aqui </a> </p>
                    </div>
