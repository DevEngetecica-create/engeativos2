...
@section('content')
    ...
    <div class="d-flex flex-row col-12 bd-highlight bg-light m-0 p-0">
        ...
        <div class="p-2 bd-highlight  align-self-center col-1  m-0 p-0">
            <h3 class="page-title">
                @if (session()->get('usuario_vinculo')->id_nivel <= 2) <a class="btn btn-sm btn-danger" href="{{route('ativo.veiculo.subCategoria.adicionar')}}">
                    Adicionar
                    </a>
                    @endif
            </h3>
        ...
        <div class=" d-flex justify-content-center p-2 bd-highlight col-lg-12 m-0 p-0 mr-5">
                ...
                <div class="p-2 bd-highlight col-lg-12 ">
                    <div class="d-flex bd-highlight col-12  ">
                        <div class="p-2  bd-highlight col-4">
                            <div class="row">
                                <label class="col-sm-3 col-form-label">Listar</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-8 p-2 flex-grow-1 bd-highlight ml-2">
                            <div class="row">
    ...
    <script>
        ...
        function carregarTabela(pagina) {
            ...
            $.ajax({
                url: "{{route('admin/ativo/veiculo/subCategoria/list')}}",
                method: 'GET',
                data: dados
            }).done(function(data) {
                $('.card-body').html(data);
