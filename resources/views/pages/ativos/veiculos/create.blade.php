                ...
                <form method="post" action="{{ route('veiculo.store') }}" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-control select2" id="idSubCategoria"
                                        name="idSubCategoria">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-select-sm" id="tipos" name="tipo" required>
                                        ...
                                        @foreach ($tipos_veiculos as $tipo_veiculo)
                                            <option value="{{ $tipo_veiculo->id }}">{{ $tipo_veiculo->nome_tipo_veiculo }} </option>
                                        @endforeach
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control form-control-sm" id="veiculos" name="veiculo" type="veiculo"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control form-control-sm text-uppercase" id="placa"
                                        name="placa" type="text" value="{{ old('placa') }}">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-2">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <input class="form-control form-control-sm" id="valor_fipe" name="valor_fipe"
                                            type="text" required>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <input class="form-control form-control-sm" id="valor_aquisicao" name="valor_aquisicao" type="text" required>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control form-control-sm" id="codigo_fipe" name="codigo_fipe"
                                        type="text" value="{{ old('codigo_fipe') }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="fipe_mes_referencia"
                                        name="fipe_mes_referencia" type="text"
                                        value="{{ old('fipe_mes_referencia') }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="mes_aquisicao" name="mes_aquisicao"
                                        type="text" value="{{ old('mes_aquisicao') }}">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-8">
                                    ...
                                    <textarea class="form-control" id="observacao" name="observacao" cols="30" rows="4">{{ old('observacao') }}</textarea>
                                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <label class="form-label" for="quilometragem_inicial">Quilometragem
                                                Inicial</label>
                                            <input class="form-control form-control-sm" id="quilometragem_inicial"
                                                name="quilometragem_inicial" type="number"
                                                value="{{ old('quilometragem_inicial') }}">
                                        </div>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <img src="{{ url('storage/imagem_ativo/nao-ha-fotos.png') }}" id="target"
                                        class="card-img-top img-fluid" id="target">

                                    <div class="card-body">

                                        <p class="card-text text-center border-top">
                                        ...
                                        <p class="text-center">
                                            @php
                                                ...
                                                echo 'Curitiba, ' . $dia . ' de ' . $mes . ' de ' . $ano;
