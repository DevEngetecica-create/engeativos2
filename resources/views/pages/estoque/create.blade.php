...
<div class="row my-3 bg-white py-3 shadow ">
    ...
    <div class="col-6 breadcrumb-item active" aria-current="page">
        <h5 class="page-title text-center">
            ...
            </span> Cadastrar Produtos do Estoque
        </h5>
    </div>
</div>
...
<form method="post" action="{{ route('ativo.estoque.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select class="form-select select2" id="id_subcategoria" name="id_subcategoria">
                                    ...
                                    <option value="{{ $subcategorie->id ?? old('id_subcategoria') }}">{{ $subcategorie->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select select2 " id="id_marca" name="id_marca" required>
                                    ...
                                    <option value="{{ $brad->id ?? old('id_marca')}}">{{ $brad->name }}</option>
                                    @endforeach
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input class="form-control " id="nome_produto" name="nome_produto" value="{{old('nome_produto')}}" type="text" placeholder="Título" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-2 col-sm-6  col-xl-6">
                                    ...
                                    <input class="form-control " id="estoque_minimo" name="estoque_minimo" value="{{old('estoque_minimo')}}" type="text" required>
                                </div>
                                
                                <div class="form-group mb-2 col-sm-6  col-xl-6">
                                    <label class="form-label" for="estoque_minimo">Valor un</label>
                                    <input class="form-control " id="valor_unitario" name="valor_unitario" value="{{old('valor_unitario')}}" type="text" required>
                                </div>

                                <div class="form-group mb-2 col-sm-6 col-lg-6">
                                    <label class="form-label" for="unidade">Unidade</label>
                                    <input class="form-control " id="unidade" name="unidade" value="{{old('unidade')}}" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="form-group col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <select class="form-control form-select" id="status_produto" value="{{old('status_produto')}}" name="status_produto" required>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" name="image" id="image" onChange="carregarImg()">
                                    <span class="text-danger">Extensões de imagens permitidas = 'png', 'jpg', 'jpeg', 'gif'</span>

                                </div>
                                <div class="form-group my-3 col-6">

                                    <img src="{{ URL::asset('imagens/estoque/nao-ha-fotos.png')}}" id="target" class="img-thumbnail" style="width: 450px;">
