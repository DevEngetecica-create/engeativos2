...
@section('content')
    ...
    <div class="row my-3 bg-white py-3 shadow ">
        <div class="col-3 active">
            <h5 class="page-title text-left m-0">
                <a class="btn btn-success" href="{{ route('ativo.estoque.categorias.index') }}">
    ...
    <div class="card">
        <div class="card-body p-5">
            ...
            <form action="{{ route('ativo.estoque.categorias.store') }}" method="POST">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col">
                    ...
                    <div id="colorDiv"
                        style="border: 1px solid rgb(190, 182, 182);border-radius:7px; width: 150px; height:150px; background-color: #ffff2; margin: 15px">
                    </div>
