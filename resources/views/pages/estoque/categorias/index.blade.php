...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-4 active m-2">
            <h5 class="page-title text-left m-0">
                <span>Categorias <i class="mdi mdi-check icon-sm text-primary align-middle"></i></span>
            </h5>
        </div>
    ...
    <form action="{{ route('ativo.estoque.categorias.index') }}" method="GET" class="mb-4">
        @csrf
        <div class="row my-4">
            <div class="col-2">
                <h3 class="page-title text-left">
                    ...
                    @if (session()->get('usuario_vinculo')->id_nivel <= 2)
                        <a href="{{ route('ativo.estoque.categorias.create') }}">
            ...
            <div class="col-10">
                <div class="row justify-content-center">
                    <div class="col-5 m-0 p-0 ">
                        <input type="text" class="form-control shadow" name="search" placeholder="Pesquisar categorias"
                    ...
                    <div class="col-2 text-left  m-0 p-0 mb-2 mx-2">
                        ...
                        <a href="{{ route('ativo.estoque.categorias.index') }}" title="Limpar pesquisa">
                ...
                <tbody>
                    @foreach ($categorias as $category)
                        <tr>
                            ...
                            <td class="d-flex">
                                {{-- <a href="{{ route('ativo.estoque.categorias.show', $category->id) }}"
                                    class="btn btn-success btn-sm mr-1"><i class="mdi mdi-eye"></i></a> --}}

                                <a href="{{ route('ativo.estoque.categorias.edit', $category->id) }}"
                                    class="btn btn-warning btn-sm mx-2"><i class="mdi mdi-pencil"></i></a>

                                <form action="{{ route('ativo.estoque.categorias.destroy', $category->id) }}"
                                    method="POST"
