...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-4 active m-2">
            <h5 class="page-title text-left m-0">
                <span>SubCategorias <i class="mdi mdi-check icon-sm text-primary align-middle"></i></span>
            </h5>
        </div>
    ...
    <form action="{{ route('ativo.estoque.subcategorias.index') }}" method="GET" class="mb-4">
        @csrf
        <div class="row my-4">
            <div class="col-2">
                <h3 class="page-title text-left">
                    @if (session()->get('usuario_vinculo')->id_nivel <= 2)
                        <a href="{{ route('ativo.estoque.subcategorias.create') }}">
            ...
            <div class="col-10">
                <div class="row justify-content-center">
                    ...
                    <div class="col-2 text-left  m-0 p-0 mb-2 mx-2">
                        ...
                        <a href="{{ route('ativo.estoque.subcategorias.index') }}" title="Limpar pesquisa">
                    ...
                    @foreach ($subcategorias as $subcategory)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                               {{--  <a href="{{ route('ativo.estoque.subcategorias.show', $subcategory->id) }}"
                                    class="btn btn-primary btn-sm"><i class="mdi mdi-eye"></i></a> --}}

                                <a href="{{ route('ativo.estoque.subcategorias.edit', $subcategory->id) }}"
                                    class="btn btn-secondary btn-sm mx-2"><i class="mdi mdi-pencil"></i></a>

                                <form action="{{ route('ativo.estoque.subcategorias.destroy', $subcategory->id) }}"
                                    method="POST"
