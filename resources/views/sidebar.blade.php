    ...
    <div class="navbar-brand-box">
        ...
        <a href="/index" class="logo logo-dark">
            ...
            <span class="logo-sm">
                ...
                <img src="{{ URL::asset('build/images/icones/Engeativos Logo C.png') }}" data-logo-url="{{ URL::asset('build/images/icones/' . urlencode('Engeativos Logo C.png')) }}" alt="" height="22">

            </span>

            <span class="logo-lg">

                <img src="{{ URL::asset('build/images/icones/Engeativos Logo C.png') }}" data-logo-url="{{ URL::asset('build/images/icones/' . urlencode('Engeativos Logo C.png')) }}" alt="" height="50">
